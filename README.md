...
│   ├── calculators.css     # Styles for the calculator interface
│   └── Learn_more.css      # Typography & layout for educational content
│
├── 📂 js/                  # JavaScript Logic
│   ├── about.js            # Logic for Swiper sliders in About Us
│   ├── topics.js           # Logic for the topic slider/track
│   └── main.js             # General functions (Hamburger menu, Auth states)
│
├── 📂 images/              # Visual Assets
│   ├── logo.png            # Site favicon and header logo
│   └── [other-images].jpg  # Backgrounds and topic thumbnails
│
├── 📂 videos/              # Video Assets
│   └── [bg-video].mp4      # Background video for the home section
│
├── 📄 index.html           # Landing Page
├── 📄 topics.html          # Interactive Topics Gallery
├── 📄 Learn_more.html      # Detailed Math Content (MathJax integrated)
